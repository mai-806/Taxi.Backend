...
DataBaseListner::DBListner::DBListner(const userver::components::ComponentConfig& config,
...
std::string DataBaseListner::DBListner::HandleRequestThrow(const userver::server::http::HttpRequest& request,
...
std::string DataBaseListner::DBListner::checkUser(const userver::server::http::HttpRequest& request) const{
...
std::string DataBaseListner::DBListner::registerUser(const userver::server::http::HttpRequest& request) const{
...
std::string DataBaseListner::DBListner::changePassword(const userver::server::http::HttpRequest& request) const{
